...
#Class Type para la creacion de tipos
class Type:  
...
class PatientType(Type):
    def __init__(self):
        Type.__init__(self, 'patient')

    def __eq__(self, other):
        return other.name == self.name or isinstance(other, PatientType)
...
class TrueType(BoolType):
    def __init__(self):
        BoolType.__init__(self, 'True')
